	...
	if time-checktime>1 then
		...
		for name,_ in pairs(players) do
			...
			if player ~= nil then
				...
				if checkx~=pos.x or checkz~=pos.z then
					...
					if node.name=="default:water_source" or node.name=="default:water_flowing"
						or node1.name=="default:water_source" or node1.name=="default:water_flowing" or
						default.player_attached[name] == true then
						if not water then
